...
#
    ...
    proc axi_vdma_generate {drv_handle} {
        ...
        set_drv_conf_prop $drv_handle C_INCLUDE_MM2S xlnx,include-mm2s $node
        set_drv_conf_prop $drv_handle C_INCLUDE_MM2S_DRE xlnx,include-mm2s-dre $node
        set_drv_conf_prop $drv_handle C_M_AXI_MM2S_DATA_WIDTH xlnx,mm2s-data-width $node
        set_drv_conf_prop $drv_handle C_INCLUDE_S2MM xlnx,include-s2mm $node
        set_drv_conf_prop $drv_handle C_INCLUDE_S2MM_DRE xlnx,include-s2mm-dre $node
        set_drv_conf_prop $drv_handle C_M_AXI_S2MM_DATA_WIDTH xlnx,s2mm-data-width $node
        set_drv_conf_prop $drv_handle C_ENABLE_VIDPRMTR_READS xlnx,enable-vidparam-reads $node
        set_drv_conf_prop $drv_handle C_FLUSH_ON_FSYNC xlnx,flush-on-fsync $node
        set_drv_conf_prop $drv_handle C_MM2S_LINEBUFFER_DEPTH xlnx,mm2s-linebuffer-depth $node
        set_drv_conf_prop $drv_handle C_S2MM_LINEBUFFER_DEPTH xlnx,s2mm-linebuffer-depth $node
        set_drv_conf_prop $drv_handle C_MM2S_GENLOCK_MODE xlnx,mm2s-genlock-mode $node
        set_drv_conf_prop $drv_handle C_S2MM_GENLOCK_MODE xlnx,s2mm-genlock-mode $node
        set_drv_conf_prop $drv_handle C_INCLUDE_INTERNAL_GENLOCK xlnx,include-internal-genlock $node
        set_drv_conf_prop $drv_handle C_S2MM_SOF_ENABLE xlnx,s2mm-sof-enable $node
        set_drv_conf_prop $drv_handle C_M_AXIS_MM2S_TDATA_WIDTH xlnx,mm2s-tdata-width $node
        set_drv_conf_prop $drv_handle C_S_AXIS_S2MM_TDATA_WIDTH xlnx,s2mm-tdata-width $node
        set_drv_conf_prop $drv_handle c_enable_vert_flip xlnx,enable-vert-flip $node
        set_drv_conf_prop $drv_handle C_ENABLE_DEBUG_INFO_1 xlnx,enable-debug-info-1 $node
        set_drv_conf_prop $drv_handle C_ENABLE_DEBUG_INFO_5 xlnx,enable-debug-info-5 $node
        set_drv_conf_prop $drv_handle C_ENABLE_DEBUG_INFO_6 xlnx,enable-debug-info-6 $node
        set_drv_conf_prop $drv_handle C_ENABLE_DEBUG_INFO_7 xlnx,enable-debug-info-7 $node
        set_drv_conf_prop $drv_handle C_ENABLE_DEBUG_INFO_9 xlnx,enable-debug-info-9 $node
        set_drv_conf_prop $drv_handle C_ENABLE_DEBUG_INFO_13 xlnx,enable-debug-info-13 $node
        set_drv_conf_prop $drv_handle C_ENABLE_DEBUG_INFO_14 xlnx,enable-debug-info-14 $node
        set_drv_conf_prop $drv_handle C_ENABLE_DEBUG_INFO_15 xlnx,enable-debug-info-15 $node
    ...
    #   incr vdma_count
        if {[string match -nocase $mainline_ker "none"]} {
                ...
                switch $proc_type {
                        ...
                        axi_vdma_generate_clk_nodes $drv_handle $tx_chan $rx_chan
        }
    }
    ...
    proc axi_vdma_generate_clk_nodes {drv_handle tx_chan rx_chan} {
        set proc_type [get_hw_family]
        set clocknames "s_axi_lite_aclk"
