...
#
    ...
    proc iomodule_generate {drv_handle} {
        ...
        set max_intr_size 0
        set periph_num_intr_internal [iomodule_get_num_intr_internal $slave]
        set periph_num_intr_inputs [iomodule_get_num_intr_inputs $slave]
    ...
    proc iomodule_get_num_intr_inputs {slave} {
