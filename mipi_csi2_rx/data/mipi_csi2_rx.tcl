...
#
    ...
    proc mipi_csi2_rx_generate {drv_handle} {
        ...
        mipi_csi2_rx_gen_pixel_format $node $cmn_pxl_format $dts_file
                    ...
                    if {[llength $ip_mem_handles]} {
                            ...
                            if {[llength $connectip]} {
                                    ...
                                    if {[string match -nocase [hsi get_property IP_NAME $connectip] "v_frmbuf_wr"]} {
                                            mipi_csi2_rx_gen_frmbuf_node $connectip $drv_handle $dts_file
                                    }
                                }
                            }
                    }
    ...
    mipi_csi2_rx_gen_gpio_reset $drv_handle $node

    }
    proc mipi_csi2_rx_gen_pixel_format {node pxl_format dts_file} {
            set pixel_format ""
            switch $pxl_format {
                   "YUV422_8bit" {
    ...
    proc mipi_csi2_rx_gen_frmbuf_node {outip drv_handle dts_file} {
    ...
    proc mipi_csi2_rx_gen_gpio_reset {drv_handle node} {
            set dts_file [set_drv_def_dts $drv_handle]
