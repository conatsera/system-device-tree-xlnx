...
proc cpm_pcie_generate {drv_handle} {
	...
	if {($rev_num == 1) && ($port_type_1 == 1)} {
		...
		if {$node == 0} {
	        ...
	        set ranges "0x02000000 0x0 0xe8000000 0x0 0xe8000000 0x0 0x10000000>,<0x43000000 0xa0 0x00000000 0xa0 0x00000000 0x0 0x80000000"
	        add_prop $node "ranges" $ranges hexlist "pcw.dtsi" 1
	        set reg "0x07 0x00000000 0x00 0x1000000>,<0x00 0xfcdd0000 0x00 0x1000>,<0x00 0xfcea0000 0x00 0x1000000"
